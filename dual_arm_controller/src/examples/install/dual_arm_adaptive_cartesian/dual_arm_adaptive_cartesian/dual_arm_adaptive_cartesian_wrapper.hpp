...
class dual_arm_adaptive_cartesianModelClass;

namespace dual_arm_adaptive_cartesian {

struct P_dual_arm_adaptive_cartesian{
...
struct U_dual_arm_adaptive_cartesian{
...
struct Y_dual_arm_adaptive_cartesian{
Eigen::Matrix<double,14,1> tau_J_d;
Y_dual_arm_adaptive_cartesian(){
tau_J_d.setZero();
}
};
struct L_dual_arm_adaptive_cartesian{
Eigen::Matrix<double,6,1> F_add_l;
Eigen::Matrix<double,6,1> K_x_l;
Eigen::Matrix<double,6,1> F_add_r;
Eigen::Matrix<double,6,1> K_x_2_r;
L_dual_arm_adaptive_cartesian(){
F_add_l.setZero();
K_x_l.setZero();
F_add_r.setZero();
K_x_2_r.setZero();
...
class dual_arm_adaptive_cartesian{
public:
dual_arm_adaptive_cartesian();
~dual_arm_adaptive_cartesian();
void initialize(bool log = false,unsigned long long l_len = 0,const std::string& path_logs="");
void step();
void terminate();
P_dual_arm_adaptive_cartesian p;
U_dual_arm_adaptive_cartesian u;
Y_dual_arm_adaptive_cartesian y;
L_dual_arm_adaptive_cartesian l;

private:
void write_input();
void write_output();
void write_log();
std::unique_ptr<dual_arm_adaptive_cartesianModelClass> m_model;
std::vector<U_dual_arm_adaptive_cartesian> m_log_u;
std::vector<Y_dual_arm_adaptive_cartesian> m_log_y;
std::vector<L_dual_arm_adaptive_cartesian> m_log_l;
